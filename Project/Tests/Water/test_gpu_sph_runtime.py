...
class GpuSphRuntimeTests(unittest.TestCase):
    @classmethod
    ...
    def test_simulation_constant_layout_contains_core_fields(self) -> None:
    ...
    def test_particle_capacity_remains_65536(self) -> None:
    ...
    def test_gravity_integrates_velocity(self) -> None:
    ...
    def test_boundary_handles_predicted_and_final_position(self) -> None:
    ...
    def test_exposes_density_pressure_and_viscosity_kernels(self) -> None:
    ...
    def test_density_keeps_predicted_position_and_poly6_contract(self) -> None:
    ...
    def test_wc_sph_pressure_fallback_remains_available(self) -> None:
    ...
    def test_viscosity_uses_scratch_to_avoid_velocity_race(self) -> None:
    ...
    def test_prediction_has_predict_and_integrate_stages(self) -> None:
    ...
    def test_diagnostics_exposes_sph_controls(self) -> None:
        for marker in (
            "SPHシミュレーション",
            "SPHを一時停止",
            "SPHを1ステップ実行",
            ...
            self.assertIn(marker, self.diagnostics)  # 日本語化した診断UIが主要SPH設定を引き続き公開することを確認する。
