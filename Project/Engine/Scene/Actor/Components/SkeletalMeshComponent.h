...
namespace Ken4lowEngine
{
	...
	/// -------------------------------------------------------------
	class SkeletalMeshComponent : public SceneComponent, public ReflectionCaptureDrawable
	{
	public:
		...
		Vector3 GetReflectionCaptureSortPosition() const override { return GetWorldPosition(); }
